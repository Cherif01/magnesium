...
import { AddNewComponent } from './pages/_depense/_components/add-new/add-new.component';
import { CategorieComponent } from './pages/_depense/_components/categorie/categorie.component';
